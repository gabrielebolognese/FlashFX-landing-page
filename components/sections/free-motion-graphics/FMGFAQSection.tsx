...
import { fmgFaqData } from './fmgFaqData';

export function FMGFAQSection() {
          ...
          {fmgFaqData.map((faq, index) => (
            ...
            >
              <button
                ...
                aria-controls={`fmg-faq-answer-${index}`}
              >
              ...
              {openIndex === index && (
                <div id={`fmg-faq-answer-${index}`} className="px-6 pb-4">
