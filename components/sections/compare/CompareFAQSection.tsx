...
import { compareFaqData } from './compareFaqData';
    ...
    <section className="relative w-full px-6 py-16 md:py-24 bg-fx-bg-surface">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-4">
          {compareFaqData.map((faq, index) => (
            ...
            >
              ...
              {openIndex === index && (
                <div id={`compare-faq-answer-${index}`} className="px-6 pb-4">
        ...
        >
          ...
          , the comparison closest to what FlashFX is actually for.
        </motion.p>
      </div>
    </section>
  );
