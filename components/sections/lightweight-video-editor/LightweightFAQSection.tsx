...
import { lightweightFaqData } from './lightweightFaqData';

export function LightweightFAQSection() {
    ...
    <section className="relative w-full px-6 py-16 md:py-24 bg-fx-bg-surface">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-4">
          {lightweightFaqData.map((faq, index) => (
            <motion.div
              key={index}
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              <button
                ...
                aria-controls={`lw-faq-answer-${index}`}
              >
              ...
              {openIndex === index && (
                <div id={`lw-faq-answer-${index}`} className="px-6 pb-4">
